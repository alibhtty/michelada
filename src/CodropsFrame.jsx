  ...
  return (
    <div className="frame">
      <header className="frame__header">
        ...
        <a
          className="frame__changarrito"
          target="_blank" 
          href="https://changarrito.es"
        >
          el changarrito
        </a>
      </header>
      <button className="click__anywhere">Disponible en nuestros restaurantes desde el 04 Diciembre</button>
    </div>
  );
};
